...
public class PagedtableExample extends UI {
    ...
    @VaadinServletConfiguration(ui = PagedtableExample.class, productionMode = false)
    ...
    public PagedTable createTable() {
        ...
        pagedTable.addGeneratedColumn("Generated", new ColumnGenerator() {
            ...
            public Label generateCell(Table source, Object itemId,
                                      Object columnId) {
        ...
        pagedTable.setColumnHeaders(new String[]{"Name of country", "Country code",
                "A generated column."});
        return pagedTable;
    }
